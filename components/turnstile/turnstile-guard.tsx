...
const CloudflareLogo = ({ color }: { color: string }) => (
  ...
  >
    <path
      d="M16.383 6.237C15.063 4.92 13.191 4 11.001 4C6.031 4 2.001 8.03 2.001 13C2.001 17.97 6.031 22 11.001 22C14.391 22 17.311 20.11 18.991 17.25C18.991 17.25 19.001 17.25 19.001 17.25L19.001 13H11.001V9H22.001C22.001 10.13 21.751 11.2 21.301 12.17L16.383 6.237Z"
      fill={color}
    />
    <path
      d="M19 2H5C3.34 2 2 3.34 2 5V19C2 20.66 3.34 22 5 22H19C20.66 22 22 20.66 22 19V5C22 3.34 20.66 2 19 2ZM11 19C7.13 19 4 15.87 4 12C4 8.13 7.13 5 11 5C12.76 5 14.37 5.65 15.62 6.75L17.25 5.12C15.63 3.81 13.48 3 11 3C6.03 3 2 7.03 2 12C2 16.97 6.03 21 11 21C13.48 21 15.63 20.19 17.25 18.88L15.62 17.25C14.37 18.35 12.76 19 11 19Z"
      fill="none"
    />{" "}
    {/* Simplified for example, actual logo is more complex */}
  </svg>
);
  ...
  return (
    <div style={styles.container}>
      ...
      >
        ...
        {error && (
          <p style={{ ...styles.statusText, ...styles.errorText }}>
            验证失败: {error}
          </p>
        )}
